...
RENAME TABLE `shopsuite_tax_codes` TO `shopsuite_tax_codes_backup`;
...
RENAME TABLE `shopsuite_sales_taxes` TO `shopsuite_sales_taxes_backup`;
...
CREATE TABLE IF NOT EXISTS `shopsuite_tax_jurisdictions` (
...
RENAME TABLE `shopsuite_tax_code_rates` TO `shopsuite_tax_code_rates_backup`;

CREATE TABLE IF NOT EXISTS `shopsuite_tax_rates` (

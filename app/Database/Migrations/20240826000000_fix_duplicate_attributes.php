...
class fix_duplicate_attributes extends Migration
{
    ...
    public function up(): void
    {
        ...
        $foreignKeys = [
            'shopsuite_attribute_links_ibfk_1',
            'shopsuite_attribute_links_ibfk_2',
            'shopsuite_attribute_links_ibfk_3',
            'shopsuite_attribute_links_ibfk_4',
            'shopsuite_attribute_links_ibfk_5'
        ];

...
INSERT INTO `shopsuite_employees` (`username`, `password`, `person_id`, `deleted`, `hash_version`) VALUES
...
INSERT INTO `shopsuite_people` (`first_name`, `last_name`, `phone_number`, `email`, `address_1`, `address_2`, `city`, `state`, `zip`, `country`, `comments`, `person_id`) VALUES
...
INSERT INTO `shopsuite_permissions` (`permission_id`, `module_id`, `location_id`) VALUES
    ('items_stock', 'items', 1),
    ('sales_stock', 'sales', 1),
...
--
-- Table structure for table `shopsuite_sales_suspended`
--

CREATE TABLE `shopsuite_sales_suspended` (
     `sale_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
     `customer_id` int(10) DEFAULT NULL,
     `employee_id` int(10) NOT NULL DEFAULT '0',
     `comment` text NOT NULL,
...
--
-- Dumping data for table `shopsuite_sales_suspended`
--
...
--
-- Table structure for table `shopsuite_sales_suspended_items`
--

CREATE TABLE `shopsuite_sales_suspended_items` (
    `sale_id` int(10) NOT NULL DEFAULT '0',
    `item_id` int(10) NOT NULL DEFAULT '0',
    `description` varchar(30) DEFAULT NULL,
    `serialnumber` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `shopsuite_sales_suspended_items`
--
...
--
-- Table structure for table `shopsuite_sales_suspended_items_taxes`
--

CREATE TABLE `shopsuite_sales_suspended_items_taxes` (
    `sale_id` int(10) NOT NULL,
    `item_id` int(10) NOT NULL,
    `line` int(3) NOT NULL DEFAULT '0',
    `name` varchar(255) NOT NULL,
...
--
-- Dumping data for table `shopsuite_sales_suspended_items_taxes`
--
...
--
-- Table structure for table `shopsuite_sales_suspended_payments`
--

CREATE TABLE `shopsuite_sales_suspended_payments` (
    `sale_id` int(10) NOT NULL,
    `payment_type` varchar(40) NOT NULL,
    `payment_amount` decimal(15,2) NOT NULL,
    PRIMARY KEY (`sale_id`,`payment_type`)
...
--
-- Dumping data for table `shopsuite_sales_suspended_payments`
--

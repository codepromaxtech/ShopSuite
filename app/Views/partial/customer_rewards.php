...
?>
    ...
    <div class="form-group form-group-sm" style="<?= $reward_category['deleted'] ? 'display: none;' : 'display: block;' ?>">
        ...
        <span class="add_customer_reward glyphicon glyphicon-plus u-padding-top-05em"></span>
        <span>&nbsp;&nbsp;</span>
        <span class="remove_customer_reward glyphicon glyphicon-minus u-padding-top-05em"></span>
    </div>

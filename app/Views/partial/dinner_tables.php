...
?>
    ...
    <div class="form-group form-group-sm" style="<?= $table['deleted'] ? 'display: none;' : 'display: block;' ?>">
        ...
        <span class="add_dinner_table glyphicon glyphicon-plus u-padding-top-05em"></span>
        <span>&nbsp;&nbsp;</span>
        <span class="remove_dinner_table glyphicon glyphicon-minus u-padding-top-05em"></span>
    </div>

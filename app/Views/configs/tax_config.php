...
<?= form_open('config/saveTax/', ['id' => 'tax_config_form', 'class' => 'config-form']) ?>
    <div class="config-wrapper">
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.tax_id'), 'tax_id', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
                        'name'  => 'tax_id',
                        'id'    => 'tax_id',
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.tax_included'), 'tax_included', ['class' => 'form-label']) ?>
                <div>
                    <?= form_checkbox([
                        'name'    => 'tax_included',
                        'id'      => 'tax_included',
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.default_tax_rate_1'), 'default_tax_1_rate', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.default_tax_rate_2'), 'default_tax_2_rate', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.use_destination_based_tax'), 'use_destination_based_tax', ['class' => 'form-label']) ?>
                <div>
                    <?= form_checkbox([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.default_tax_code'), 'default_tax_code', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'default_tax_code',
                        $tax_code_options,
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.default_tax_category'), 'default_tax_category', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.default_tax_jurisdiction'), 'default_tax_jurisdiction', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(

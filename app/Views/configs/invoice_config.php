...
<?= form_open('config/saveInvoice/', ['id' => 'invoice_config_form', 'class' => 'config-form']) ?>
    <div class="config-wrapper">
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.invoice_enable'), 'invoice_enable', ['class' => 'form-label']) ?>
                <div>
                    <?= form_checkbox([
                        'name'    => 'invoice_enable',
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.invoice_type'), 'invoice_type', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'invoice_type',
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.recv_invoice_format'), 'recv_invoice_format', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.invoice_default_comments'), 'invoice_default_comments', ['class' => 'form-label']) ?>
                <div>
                    <?= form_textarea([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.invoice_email_message'), 'invoice_email_message', ['class' => 'form-label']) ?>
                <div>
                    <?= form_textarea([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.line_sequence'), 'line_sequence', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'line_sequence',
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.sales_invoice_format'), 'sales_invoice_format', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.last_used_invoice_number'), 'last_used_invoice_number', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
                        'type'  => 'number',
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.sales_quote_format'), 'sales_quote_format', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.last_used_quote_number'), 'last_used_quote_number', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
                        'type'  => 'number',
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.quote_default_comments'), 'quote_default_comments', ['class' => 'form-label']) ?>
                <div>
                    <?= form_textarea([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.work_order_enable'), 'work_order_enable', ['class' => 'form-label']) ?>
                <div>
                    <?= form_checkbox([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.work_order_format'), 'work_order_format', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.last_used_work_order_number'), 'last_used_work_order_number', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
                        'type'  => 'number',

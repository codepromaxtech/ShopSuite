...
<?= form_open('config/saveLocale/', ['id' => 'locale_config_form', 'class' => 'config-form']) ?>
    <div class="config-wrapper">
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.number_locale'), 'number_locale', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
                        'name'  => 'number_locale',
                        'id'    => 'number_locale',
                ...
                <div>
                    <label class="form-label">
                        <a href="https://github.com/shopsuite/shopsuite/wiki/Localisation-support" target="_blank">
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.thousands_separator'), 'thousands_separator', ['class' => 'form-label']) ?>
                <div>
                    <?= form_checkbox([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.currency_symbol'), 'currency_symbol', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.currency_code'), 'currency_code', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
                        'name'  => 'currency_code',
                        'id'    => 'currency_code',
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.currency_decimals'), 'currency_decimals', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'currency_decimals',
                        [
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.tax_decimals'), 'tax_decimals', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'tax_decimals',
                        [
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.quantity_decimals'), 'quantity_decimals', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'quantity_decimals',
                        [
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.cash_decimals'), 'cash_decimals', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'cash_decimals',
                        [
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.cash_rounding'), 'cash_rounding_code', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'cash_rounding_code',
                        $rounding_options,
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.payment_options_order'), 'payment_options_order', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.country_codes'), 'country_codes', ['class' => 'form-label']) ?>
                <div>
                    <?= form_input([
                        'name'  => 'country_codes',
                        'class' => 'form-control input-sm',
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.language'), 'language', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'language',
                        get_languages(),
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.timezone'), 'timezone', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'timezone',
                        get_timezones(),
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.datetimeformat'), 'datetimeformat', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'dateformat',
                        get_dateformats(),
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.date_or_time_format'), 'date_or_time_format', ['class' => 'form-label']) ?>
                <div>
                    <?= form_checkbox([
            ...
            <div class="form-group mb-4">
                <?= form_label(lang('Config.financial_year'), 'financial_year', ['class' => 'form-label']) ?>
                <div>
                    <?= form_dropdown(
                        'financial_year',
                        [

        ...
        <div class="lg:col-span-1">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('giftcards') ?>" class="btn btn-outline btn-block mt-space-3">
                        <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if ($is_edit): ?>
                        <button type="button" class="btn btn-danger btn-block u-margin-top-space-3" onclick="deleteGiftcard()">
                            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">

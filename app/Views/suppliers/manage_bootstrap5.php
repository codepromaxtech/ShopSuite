...
<script type="text/javascript">
    ...
    function filterRecent() {
        ...
        showNotification('Showing suppliers from last 7 days', 'info');
    }
    ...
    function filterActive() {
        ...
        showNotification('Showing active suppliers only', 'info');
    }
    ...
    async function bulkEmail() {
        ...
        if (selected.length === 0) {
            showNotification('Please select suppliers first', 'warning');
            return;
        }
...
<div class="d-flex justify-content-between align-items-center mb-3 slide-down">
    <div>
        <h2 class="mb-0"><?= lang('Module.suppliers') ?></h2>
        <p class="text-muted mb-0 small">Manage your supplier database</p>
    </div>

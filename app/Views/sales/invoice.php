...
<head>
    ...
    <title>Invoice #<?= esc($invoice_number) ?> - Complete</title>
...
<div class="receipt-page">
    <div class="receipt-container sale-doc-container">
        <div class="receipt-success-header print-hide">
            ...
            <h1 class="u-margin-008px_font-size-32px_font-weigh">Invoice Created!</h1>
            <p class="u-margin-0_font-size-16px_opacity-09">Invoice record stored successfully</p>
        </div>
        ...
        <div class="receipt-content">
            <div class="sale-doc-header-row">
                ...
                <div class="sale-doc-meta-col">
                    <h1 class="sale-doc-title"><?= lang('Sales.invoice') ?></h1>
                ...
                <tbody>
                    <?php foreach ($cart as $line => $item): ?>
                        ...
                        <tr class="sale-doc-row">
                            ...
                            <?php endif; ?>
                            <td class="sale-doc-td sale-doc-td-bold">
                                <?= ($item['is_serialized'] || $item['allow_alt_description']) && !empty($item['description']) ? esc($item['description']) : esc($item['name'] . ' ' . $item['attribute_values']) ?>
                            </td>
                        ...
                        <?php if ($item['is_serialized'] && !empty($item['serialnumber'])): ?>
                            <tr class="sale-doc-row-serial">
                                <td></td>
                                <?php if ($include_hsn): ?><td></td><?php endif; ?>
                                <td colspan="5" class="sale-doc-serial-cell">SN: <?= esc($item['serialnumber']) ?></td>
                            </tr>
                        <?php endif; ?>
                        <?php endif; ?>
                    <?php endforeach; ?>
            ...
            <div class="sale-doc-footer">
                ...
                <div class="sale-doc-barcode-col">
                    <?php if (!empty($barcode) && is_string($barcode)): ?>
                        <div class="sale-doc-barcode-wrap"><?= $barcode ?></div>

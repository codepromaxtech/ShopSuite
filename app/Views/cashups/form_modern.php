    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="card u-margin-bottom-space-6">
                ...
                <div class="card-body">
                    <div class="u-font-size-text-3xl_font-weight-font-bo" id="cashupTotal">
                        $<?= number_format($cash_ups_info->closed_amount_total ?? 0, 2) ?>
                    </div>
                    <p class="u-font-size-text-sm_color-text-secondary-1">
                        Net Difference
                    </p>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('cashups') ?>" class="btn btn-outline btn-block mt-space-3">
                        <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <?php if ($is_edit): ?>
                        <button type="button" class="btn btn-danger btn-block u-margin-top-space-3" onclick="deleteCashup()">
                            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
class Reports extends Secure_Controller
{
    ...
    public function getIndex(): void
    {
        ...
        $data = [
            ...
            'allowed_modules' => $this->global_view_data['allowed_modules'],
            'user_info' => $this->global_view_data['user_info'],
            'config' => $this->global_view_data['config']
        ];

        echo view('reports/manage_modern', $data);
    }
    ...
    {   // TODO: Duplicated code
        ...
        echo view('reports/tabular_modern', $data);
    }
    ...
    public function summary_discounts_input(): void
    {
        ...
        echo view('reports/date_input_modern', $data);
    }
    ...
    public function graphical_summary_expenses_categories(string $start_date, string $end_date, string $sale_type): void
    {
        ...
        echo view('reports/graphical_modern', $data);
    }
    ...
    public function specific_customer_input(): void
    {
        ...
        echo view('reports/specific_input_modern', $data);
    }
    ...
    public function inventory_summary_input(): void
    {
        ...
        echo view('reports/inventory_summary_input_modern', $data);
    }

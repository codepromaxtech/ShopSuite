...
class Config extends Secure_Controller
{
    ...
    /**
     * This function loads all the licenses starting with the first one being ShopSuite one
     */
    private function _licenses(): array    // TODO: remove hungarian notation.  Super long function.  Perhaps we need to refactor out functions?
    {
        ...
        if (file_exists('license/LICENSE')) {
            ...
            $license[$i]['text'] = 'LICENSE file must be in ShopSuite license directory. You are not allowed to use ShopSuite application until the distribution copy of LICENSE file is present.';
        }
    ...
    public function postSaveGeneral(): void
    {
        ...
        if ($batch_save_data['category_dropdown'] == 1) {
            $definition_data['definition_name'] = 'shopsuite_category';

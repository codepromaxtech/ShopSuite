...
return [
    ...
    'welcome_message' => "Selamat Datang di ShopSuite, klik modul di bawah ini untuk memulai.",
    'yes' => "Iya",
    'you_are_using_shopsuite' => "Anda menggunakan Open Source Point Of Sale Versi",
    'zip' => "Kode POS",
];

...
return [
    ...
    "os_timezone"                               => "ShopSuite fuso orario:",
    "shopsuite_info"                                => "Informazioni sull'installazione di ShopSuite",
    ...
    "timezone"                                  => "Timezone",
    "timezone_error"                            => "Il fuso orario ShopSuite è diverso dal fuso orario locale.",
    "top"                                       => "Sopra",

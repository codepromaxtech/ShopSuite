...
return [
    ...
    "os_timezone"                               => "Fuso horário do ShopSuite:",
    "shopsuite_info"                                => "Informações de instalação do ShopSuite",
    ...
    "timezone_error"                            => "O fuso horário do ShopSuite é diferente do fuso horário local.",
    "top"                                       => "Topo",

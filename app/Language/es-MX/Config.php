...
return [
    ...
    "os_timezone"                               => "Zona horaria ShopSuite:",
    "shopsuite_info"                                => "Información de instalación ShopSuite",
    ...
    "timezone"                                  => "Timezone",
    "timezone_error"                            => "La zona horaria de ShopSuite es diferente a su zona horaria local.",
    "top"                                       => "Top",

...
return [
    ...
    "software_short"                 => "ShopSuite",
    "software_title"                 => "Punto de Venta de Código Abierto (ShopSuite)",
    "state"                          => "Estado",
    "submit"                         => "Enviar",
    ...
    "welcome_message"                => "Bienvenido(a) a ShopSuite, haga clic en un módulo para comenzar.",
    "yes"                            => "Si",
    "you_are_using_shopsuite"            => "Está utilizando la versión de Código Abierto de Punto de Venta",
    "zip"                            => "CP",
];

...
return [
    ...
    "website"                        => "เว็บไซต์ shopsuite.org",
    "welcome"                        => "ยินดีต้อนรับ",
    "welcome_message"                => "ยินดีต้อนรับสู่ ShopSuite, กรุณาเลือกโมดูลด้านล่างที่ต้องการทำงาน",
    "yes"                            => "ใช่",
    "you_are_using_shopsuite"            => "คุณกำลังใช้ โอเพนซอร์ส พีโอเอส รุ่น",
    "zip"                            => "รหัสไปรษณีย์",
];

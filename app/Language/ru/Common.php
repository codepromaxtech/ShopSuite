...
return [
    ...
    "welcome_message"                => "Добро пожаловать в ShopSuite, нажмите на модули ниже, чтобы начать.",
    "yes"                            => "",
    "you_are_using_shopsuite"            => "Вы использоваете Open Source Point Of Sale Версия",
    "zip"                            => "Почтовый индекс",
];

...
return [
    ...
    "os_timezone"                               => "Часова зона ShopSuite:",
    "shopsuite_info"                                => "Інформація про встановлення ShopSuite",
    "payment_options_order"                     => "Варіанти оплати замовлення",
    "perm_risk"                                 => "Неправильні дозволи роблять ShopSuite вразливим.",
    ...
    "timezone_error"                            => "Часовий пояс ShopSuite відрізняється від вашого місцевого часового поясу.",
    "top"                                       => "Головний",

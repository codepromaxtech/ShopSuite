...
return [
    ...
    "os_timezone"                               => "ShopSuite Saat qurşağı:",
    "shopsuite_info"                                => "ShopSuite quraşdırılması məlumatı",
    ...
    "timezone_error"                            => "ShopSuite Saat qurşağı Yerli saat qurşağınızdan fərqlidir.",
    "top"                                       => "Yuxarı",

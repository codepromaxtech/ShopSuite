...
return [
    ...
    "welcome_message"                => "ShopSuite-a Xoş gəlmisiniz, başlamaq üçün bir modula basın.",
    "yes"                            => "",
    "you_are_using_shopsuite"            => "Açıq Layihədə Satışın Avtomatlaşdırma Nöqtəsi versiya",
    "zip"                            => "Poçt Kodu",
];

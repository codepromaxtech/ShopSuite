...
return [
    ...
    "website"                        => "Уебсайт",
    "welcome"                        => "Добре дошли",
    "welcome_message"                => "Добре дошли в ShopSuite, кликнете върху модул по-долу, за да започнете.",
    "yes"                            => "",
    "you_are_using_shopsuite"            => "Вие използвате Open Source Point Оf Sale версия",
    "zip"                            => "Пощенски код",
];

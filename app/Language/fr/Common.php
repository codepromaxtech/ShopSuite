...
return [
    ...
    "software_title"                 => "ShopSuite",
    "state"                          => "État",
    "submit"                         => "Valider",
    "total_spent"                    => "Dépenses totales",
    "unknown"                        => "Inconnu(e)",
    "view_recent_sales"              => "Voir ventes récentes",
    "website"                        => "shopsuite.org",
    "welcome"                        => "Bienvenue",
    "welcome_message"                => "Bienvenue sur ShopSuite, choisissez un module ci-dessous pour commencer.",
    "yes"                            => "Oui",
    "you_are_using_shopsuite"            => "Vous utilisez Open Source Point Of Sale Version",
    "zip"                            => "Code postal",
];

...
return [
    ...
    "os_timezone"                               => "Fuseau horaire d'ShopSuite :",
    "shopsuite_info"                                => "Informations d'installation d'ShopSuite",
    ...
    "timezone_error"                            => "Le fuseau horaire d'ShopSuite est différent de votre fuseau horaire local.",
    "top"                                       => "Haut",

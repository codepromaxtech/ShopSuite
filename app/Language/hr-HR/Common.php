...
return [
    ...
    "welcome"                        => "Dobrodošli",
    "welcome_message"                => "Dobrodošli u blagajnu otvorenog koda(ShopSuite)",
    "yes"                            => "",
    "you_are_using_shopsuite"            => "Koristite blagajnu otvorenog koda (Open Source Point Of Sale) verziju",
    "zip"                            => "Broj pošte",
];

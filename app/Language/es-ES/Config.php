...
return [
    ...
    "center"                                    => "Centro",
    "change_apperance_tooltip"                  => "Cambiar Aspecto de ShopSuite",
    "comma"                                     => "coma",
    ...
    "shopsuite_info"                                => "Información de la Instalación ShopSuite",
    ...
    "timezone_error"                            => "La zona horaria de ShopSuite es diferente de tu zona horaria local.",
    "top"                                       => "Arriba",
    "use_destination_based_tax"                 => "Usar Impuesto Basado en Destino",
    "user_timezone"                             => "Zona Horaria ShopSuite:",
    "website"                                   => "Sitio Web",
